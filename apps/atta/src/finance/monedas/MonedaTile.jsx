...
function MonedaTile({
  ...
  const isFullMobile = isFull && isMobile;

  const tileWidth = isFullMobile ? '100%' : (isFull ? MONEDA_TILE.widthFull : MONEDA_TILE.width);
  ...
  return (
    <Card
      ...
      sx={{
        ...
        height: tileHeight,
        width: isFullMobile ? '100%' : undefined,
        minWidth: isFullMobile ? 0 : tileWidth,
        maxWidth: isFullMobile ? '100%' : tileWidth,
        flex: isFullMobile ? '1 1 auto' : `0 0 ${tileWidth}px`,
