...
import { TareaRow } from '../tasks/list/TareasTable';
...
const TareaItem = ({ tarea, onUpdateTarea, showValues, updateTareaWithHistory }) => {
  ...
  const handleSubtareaToggle = async (subtareaId) => {
    ...
    try {
      ...
      setTareaLocal(tarea);
      console.error('[ObjetivosGrid] Error al actualizar subtarea:', error);
  ...
  const handleComplete = async (tarea) => {
    ...
    try {
      ...
      console.error('[ObjetivosGrid] Error al completar tarea:', error);
  ...
  const handleReactivate = async (tarea) => {
    ...
    try {
      ...
      console.error('[ObjetivosGrid] Error al reactivar tarea:', error);
