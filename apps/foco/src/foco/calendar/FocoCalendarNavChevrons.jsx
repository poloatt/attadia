...
export default function FocoCalendarNavChevrons({ viewMode, compact = false }) {
  const { onPrevious, onNext, prevTooltip, nextTooltip } = useFocoCalendarNavChevrons(viewMode);
